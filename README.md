...
## Javascript Assignments  [![Build Status](https://travis-ci.org/verasem/js-assignments.svg?branch=master)](https://travis-ci.org/verasem/js-assignments)
...
* Edit local README.md file and update all links (just replace all occurrences of `'verasem'` with your account name).
...
```
* Open https://github.com/verasem/js-assignments and test the build icon. Now it will run all tests and update status once you push changes to github. Keep this icon green!
...
* Push your updates to github server and check if tests passed on [travis-ci](https://travis-ci.org/verasem/js-assignments/builds).
